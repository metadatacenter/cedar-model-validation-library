...
# e.g., 
#
# validate-template <template_file_path>

if [ "$#" -ne 1 ]; then
    echo "Usage: <template_file_path>"
    exit 1
fi
...
python ${SCRIPTS_DIR}/jsvalid.py -s ${RESOURCES_DIR}/template-schema.json -i ${template_file_path}
